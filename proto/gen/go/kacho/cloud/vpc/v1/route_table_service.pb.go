...
// KAC-239 S3: гранулярные verb-RPC для маршрутов (static_routes JSONB + id).
...
type UpdateRouteTableRouteRequest struct {
	...
	// Новое содержимое маршрута (id берётся из route_id).
...
const file_kacho_cloud_vpc_v1_route_table_service_proto_rawDesc = "" +
	...
	"\x0fvpc_route_table\x12\x0eroute_table_id\xa2\xb5\x18\x012\xb2\xd2*&\n" +
	"\x18UpdateRouteTableMetadata\x12\n" +
	"RouteTable\x82\xd3\xe4\x93\x026:\x01*\"1/vpc/v1/routeTables/{route_table_id}:update-routeBIZGgithub.com/PRO-Robotech/kacho-vpc/proto/gen/go/kacho/cloud/vpc/v1;vpcv1b\x06proto3"
