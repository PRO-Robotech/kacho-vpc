...
type Address struct {
	...
	// kacho extension (not in verbatim YC Address): resources currently using
...
// External IPv6 address — kacho extension (KAC-58). Mirrors ExternalIpv4Address;
// allocated from a global address pool (kind=EXTERNAL_PUBLIC) with an IPv6
// CIDR block via the sparse IPv6 IPAM allocator (counter-based, see
// kacho-vpc/CLAUDE.md §16).
