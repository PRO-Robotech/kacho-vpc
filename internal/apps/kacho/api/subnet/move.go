...
func NewMoveSubnetUseCase(repo SubnetRepo, folderClient FolderClient, opsRepo operations.Repo) *MoveSubnetUseCase {
	return &MoveSubnetUseCase{repo: repo, folderClient: folderClient, opsRepo: opsRepo}
}
