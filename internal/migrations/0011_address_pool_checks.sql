...
-- здесь НЕ дублируется (второй индекс с тем же предикатом запрещён).
--
...
BEGIN
    ...
    -- буквы/цифры/дефисы/подчёркивания, начинается с буквы, до 63 символов,
    ...
    -- kind — единственное определённое значение AddressPoolKind = EXTERNAL_PUBLIC (1).
