...
// (object-scoped deny на отсутствующий объект → 404 вместо 403). Лёгкий
...
// берётся ТОЛЬКО из этой константной карты (никогда из request'а) — инъекция
// невозможна.
